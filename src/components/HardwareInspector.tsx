...
export const HardwareInspector: React.FC = () => {
  ...
  const tiles = telemetry?.tiles || [
    ...
    { row: 1, col: 3, type: "COMPUTE_AIE2", label: "Tile (1,3)", status: isZeroized ? "SCRUBBED (0x00)" : "ACTIVE", textMemoryUsed: 8510, textMemoryLimit: 16384, ramUsed: isZeroized ? 0 : 32768, ramLimit: 65536, currentTask: "DR2b Noise / CBD3", memUsage: isZeroized ? 0 : 50 },

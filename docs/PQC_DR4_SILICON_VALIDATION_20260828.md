# PQC DR4 Silicon Validation Report (2026-08-28)
...
* **Compute Grid**: 2 Compute Tiles (Row 2, Cols 0..1) connected via memory-mapped ObjectFIFOs.
...
The complete test suite executes all 25 official NIST ACVP ML-KEM-512 `K-PKE.Decrypt` vectors directly on physical silicon:

```
========================================================================
PQC DR4 - complete ML-KEM-512 K-PKE.Decrypt closure
Backend: dr4-mlkem512-kpke-decrypt:silicon
  acvp-tcId-01                     PASS
  acvp-tcId-02                     PASS
  acvp-tcId-03                     PASS
  acvp-tcId-04                     PASS
...
| :--- | :--- | :--- | :--- |
| **Ingress DMA Transfers** | 2 (`descriptor[16]`, `request[1536]`) | Exactly 2 | PASS |
| **Egress DMA Transfers** | 1 (`result[52]`) | Exactly 1 | PASS |
...
```
================================================================================
ALL 7/7 PQC MILESTONES PASSED 100% BIT-EXACT ON PHYSICAL SILICON!
================================================================================
  ...
  - DR4  (ML-KEM-512 K-PKE.Decrypt): 25/25 PASS
--------------------------------------------------------------------------------
TOTAL ON-DEVICE SILICON TESTS: 145/145 PASS (100.0% RELIABILITY)
================================================================================
```

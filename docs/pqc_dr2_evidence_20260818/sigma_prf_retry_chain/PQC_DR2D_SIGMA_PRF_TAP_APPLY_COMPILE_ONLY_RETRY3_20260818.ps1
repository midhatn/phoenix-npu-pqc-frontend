...
$evidence = ".\PQC_DR2D_sigma_prf_tap_apply_compile_only_retry3_evidence_20260818.txt"
...
try {
  & {
    "===== DR2D SIGMA-PLUS-PRF TAP RETRY3: NON-DISPATCH PROVENANCE ====="

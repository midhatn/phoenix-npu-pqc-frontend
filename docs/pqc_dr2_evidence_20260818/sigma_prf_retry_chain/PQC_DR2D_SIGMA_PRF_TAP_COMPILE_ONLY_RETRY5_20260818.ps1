...
$evidence = ".\PQC_DR2D_sigma_prf_tap_apply_compile_only_retry5_evidence_20260818.txt"
...
try {
  & {
    "===== DR2D SIGMA-PLUS-PRF TAP RETRY5: NON-DISPATCH PROVENANCE ====="
